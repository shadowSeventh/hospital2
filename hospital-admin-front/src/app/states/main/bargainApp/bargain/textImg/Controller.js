...
class Controller {
    constructor(_$scope,
        ...
        $rootScope.bargainAppId = $scope.bargainAppId = $stateParams.bargainAppId;
        ...
        $scope.finish = function () {
            // main.bargainApp.store.itemManage.itemAdd({status:'add'})
        ...
        $scope.fallbackPage = function () {
            ...
            if ($scope.from == 'add') {
                $state.go("main.bargainApp.bargain.bargainAdd", {form:'text'})
            } else if ($scope.from == 'edit') {
                $state.go("main.bargainApp.bargain.bargainEdit", {id: $scope.id,form:'text'})
            } else {
                history.back();
            }
        };
