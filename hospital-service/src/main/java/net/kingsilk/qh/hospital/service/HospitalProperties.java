package net.kingsilk.qh.hospital.service;
...
@ConfigurationProperties(prefix = "net.kingsilk.qh.bargain")
@Component
public class HospitalProperties {

    private Jwt jwt = null;
    private QhOAuth qhOAuth = null;
    private QhBargain qhBargain = null;
    ...
    public QhBargain getQhBargain() {
        return qhBargain;
    }

    public void setQhBargain(QhBargain qhBargain) {
        this.qhBargain = qhBargain;
    }
