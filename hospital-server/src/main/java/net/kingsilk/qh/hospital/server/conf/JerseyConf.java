...
import net.kingsilk.qh.hospital.server.resource.home.HomeResource;
import net.kingsilk.qh.hospital.server.resource.bargainApp.authorities.AuthoritiesResource;
