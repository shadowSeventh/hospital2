...
import net.kingsilk.qh.hospital.service.security.BargainAppIdFilter;
import net.kingsilk.qh.hospital.service.service.StaffUserDetailsService;
...
public class OAuth2ResourceServerConf {
    ...
    ResourceServerTokenServices resourceServerTokenServices(
        ...
        ts.setClientId(props.getQhBargain().getServer().getClientId());
        ts.setClientSecret(props.getQhBargain().getServer().getClientSecret());
...
//    }
    ...
    @Bean
    public BargainAppIdFilter brandAppIdFilter() {

        return new BargainAppIdFilter();
    }

    @Bean
    ResourceServerConfigurerAdapter resourceServerConfigurerAdapter(
            ResourceServerTokenServices resourceServerTokenServices,
            BargainAppIdFilter bargainAppIdFilter
    ) {
        return new ResourceServerConfigurerAdapter() {
            ...
            public void configure(ResourceServerSecurityConfigurer resources) {
                ...
                resources.resourceId("RSC_ID_qh-bargain-server")
            ...
            public void configure(HttpSecurity http) throws Exception {
                ...
                http.addFilterBefore(bargainAppIdFilter, X509AuthenticationFilter.class);
