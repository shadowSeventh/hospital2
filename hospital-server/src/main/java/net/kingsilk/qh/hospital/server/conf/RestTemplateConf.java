...
import net.kingsilk.qh.hospital.service.service.HttpRequestInterceptorService;
import net.kingsilk.qh.hospital.service.util.PlainConnectionSocketFactoryEx;
import net.kingsilk.qh.hospital.service.util.SSLConnectionSocketFactoryEx;
import net.kingsilk.qh.hospital.service.util.errorHandler.Oauth2ResponseErrorHandler;
