...
public class QBargainRecord extends EntityPathBase<BargainRecord> {
    ...
    private static final long serialVersionUID = 880658875L;
    ...
    public final StringPath bargainAwardId = createString("bargainAwardId");
    ...
    public final EnumPath<BargainRecordStatusEnum> status = createEnum("status", BargainRecordStatusEnum.class);
