...
public class QDeliverInvoice extends EntityPathBase<DeliverInvoice> {
    ...
    private static final long serialVersionUID = 1634403472L;
    ...
    public final EnumPath<DeliverStatusEnum> deliverStatus = createEnum("deliverStatus", DeliverStatusEnum.class);
