package top.ball.rice.hospital.api.util;
...
public class PackageUtils {
    ...
    public PackageUtils(String basePackage) {
        this.basePackage = basePackage;
        this.cl = getClass().getClassLoader();

    }

    public PackageUtils(String basePackage, ClassLoader cl) {
        this.basePackage = basePackage;
        this.cl = cl;
    }
    ...
    public String[] getPackageAllClassName(String classLocation, String packageName) {
        //将packageName分解
        String[] packagePathSplit = basePackage.split("[.]");
     ...
     * @param classes
     */
    public static void findAndAddClassesInPackageByFile(String basePackage, String packagePath, final boolean recursive, List<Class<?>> classes) {
        //获取此包的目录 建立一个File
        ...
        for (File file : dirfiles) {
            //如果是目录 则继续扫描
            if (file.isDirectory()) {
                findAndAddClassesInPackageByFile(basePackage + "." + file.getName(),
